...
network_config = {
    "nodes": ["S", "R1", "R2", "R3", "A", "B", "C", "D"],
    "links": [
        {"from": "S", "to": "R1", "capacity": 10 * 1000, "tau": 0.1},
        {"from": "R1", "to": "R2", "capacity": 2 * 1000, "tau": 0.2},
        {"from": "R2", "to": "A", "capacity": 1 * 1000, "tau": 0.3},
        {"from": "R2", "to": "B", "capacity": 10 * 1000, "tau": 0.4},
        {"from": "R2", "to": "R3", "capacity": 1 * 1000, "tau": 0.5},
        {"from": "R3", "to": "D", "capacity": 5 * 1000, "tau": 0.6},
        {"from": "R3", "to": "C", "capacity": 5 * 1000, "tau": 0.7},
        # Reverse links (assuming bidirectional communication)
        {"from": "R1", "to": "S", "capacity": 10 * 1000, "tau": 0.1},
        {"from": "R2", "to": "R1", "capacity": 2 * 1000, "tau": 0.2},
        {"from": "A", "to": "R2", "capacity": 1 * 1000, "tau": 0.3},
        {"from": "B", "to": "R2", "capacity": 10 * 1000, "tau": 0.4},
        {"from": "R3", "to": "R2", "capacity": 1 * 1000, "tau": 0.5},
        {"from": "D", "to": "R3", "capacity": 5 * 1000, "tau": 0.6},
        {"from": "C", "to": "R3", "capacity": 5 * 1000, "tau": 0.7},
    ]
}
